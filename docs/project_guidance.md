...
- **No value is hardcoded in the code. Any value, anywhere — none.**
- This applies to every kind of value: URLs, ports, hosts, paths, file/folder names,
  ...
  feature flags, labels, and any magic number or string.
...
### 5. Modern Stack & Approaches
- Use modern tech stacks and modern approaches in every implementation.
- Prefer current, well-supported libraries, language features, and patterns over legacy
  ones; follow the established modern patterns already in this codebase.
- No deprecated APIs or outdated idioms.
